...
class sendMail {
    ...
    public function SendMail():bool {
        ...
        $mail->Username = 'davecowan2016@gmail.com';    //SMTP username
        $mail->Password = 'Pre_fect2016';                //SMTP password
        $mail->SMTPSecure = 'ssl';                  //Enable encryption, 'ssl', ,'tsl' also accepted
        
        $mail->From = $this->fromemail;              //who mail is from
        $mail->FromName = $this->fromname;  
        $mail->addAddress($this->toemail,$this->toname);        //Adda a recipient
        ...
        $mail->AltBody = $this->messagetext;        //Alternate messasge (text only version)
